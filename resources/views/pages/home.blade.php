...
@section('bee-header')
    <div class="flex justify-items-end home-header grid grid-cols-2 py-6 px-20">
        <div class="home-header__left-content">
            <h1 class="lg:text-5xl md:text-3xl sm:text-3xl text-pink-600 font-bold home-header__title">Calendário de
                flores</h1>
        ...
        <div class="home-header__right-content flex flex-col">
            <a href="{{ route('flower') }}" class="home-header__button p-2 border rounded font-bold text-center">Cadastrar
                flor</a>
            <a href="{{ route('bee') }}" class="home-header__button p-2 border rounded mt-4 font-bold text-center">Cadastrar
                abelha</a>
        </div>
    </div>
@endsection
